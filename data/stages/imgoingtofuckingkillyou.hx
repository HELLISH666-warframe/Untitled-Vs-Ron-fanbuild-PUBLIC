...
function beatHit(curBeat){
   ...
   // doTweenAlpha('icooooonBite', 'simge2', 0, 1.5, 'quadInOut')
	...
	FlxTween.tween(boyfriend, {y: -7900}, 5.5, {ease: FlxEase.quadIn});
	FlxTween.tween(dad, {y: -6600}, 5.5, {ease: FlxEase.quadIn});
    ...
    if (curBeat == 564){
    FlxTween.tween(dead, {alpha: 1}, 1, {ease: FlxEase.quadIn});
    }
}