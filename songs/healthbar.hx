...
public var noHealthBar:Bool = PlayState.instance.SONG.meta.noHealthBar;
...
function postCreate() {
    if(classic==true)noHealthBar=true;
    trace(classic+"____"+noHealthBar);
    if(noHealthBar==true)classic=true;
    //(!StringTools.endsWith(curSong, "classic"))
    if((classic==null)||(noHealthBar==null)){
